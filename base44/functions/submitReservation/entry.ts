...
export default async function(req) {
  try {
    ...
    // Link di conferma firmato per il proprietario
    ...
    const ownerHtml = `
      <div style="font-family: Georgia, serif; max-width:560px; margin:auto; color:#1c1a18;">
        ...
        <a href="${confirmLink}" style="display:block; background:#a1491d; color:#f9f7f2; text-decoration:none; text-align:center; padding:16px 28px; border-radius:9999px; font-family:sans-serif; font-size:15px; font-weight:bold;">Conferma prenotazione</a>
        <p style="font-size:12px; color:#6b6356; margin-top:14px; text-align:center;">Clicca per confermare: il cliente riceverà subito l'email di conferma.</p>
      </div>`;
